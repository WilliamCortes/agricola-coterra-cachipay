...
export default function Contact() {
  useEffect(() => {
    applySeo({
      title: "Contacto | Agrícola Coterra",
      description: "Contáctanos para asesoría técnica, disponibilidad de productos y pedidos.",
        ...
        breadcrumb={
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="font-semibold text-primary">Contacto</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        }
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mb-8 text-lg">
                    ¿Tiene alguna pregunta sobre nuestros productos o servicios? Nuestro equipo de expertos está listo
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-sm border border-border/50 hover:border-primary/30 transition-colors">
                    ...
                    <p className="text-muted-foreground text-sm">+57 320 334 7765</p>
                  </div>

          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              <div className="relative">
                <img 
                  src="https://res.cloudinary.com/dio8wik24/image/upload/c_fill,f_auto,g_auto,h_800,q_auto,w_1200/v1/forest-elemental/products/product-6?_a=BAMAOGce0" 
            ...
            <Carousel opts={{ align: "start", loop: true }} className="w-full">
              <CarouselContent className="-ml-6">
                {testimonials?.map((testimonial) => (
                  ...
                  >
                    <div className="h-full bg-white p-8 rounded-2xl shadow-md border border-border/50 relative">
              ...
              <CarouselPrevious className="left-2 z-20 bg-white/90 hover:bg-white border-border md:left-0 md:-translate-x-full" />
              <CarouselNext className="right-2 z-20 bg-white/90 hover:bg-white border-border md:right-0 md:translate-x-full" />
            </Carousel>
          )}
        </div>
      </section>
